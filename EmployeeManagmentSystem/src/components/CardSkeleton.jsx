...
{/* // cards  */}
<div className="grid grid-cols-[repeat(auto-fit,minmax(18rem,1fr))] gap-5 max-md:justify-items-center mt-10 px-10">
{
   Array.from({length : 20}).map((item , index) => (
    <div key={index} class="bg-gray-400 rounded-md  p-5 flex flex-col justify-between gap-3 cursor-pointer animate-pulse h-96 max-md:w-full max-sm:h-60">
