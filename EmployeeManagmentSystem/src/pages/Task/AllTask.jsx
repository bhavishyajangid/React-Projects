...
const AllTask = ({ tasks, heading }) => {
  ...
  const filterTask = useCallback(async(data) => {
    ...
    if(data.employeeId == "" && data.startDate == "" && data.endDate == "") return
  ...
  return (
    <div className="px-5 py-5 flex flex-col gap-5  ">
     ...
     <h1 className="text-xl md:text-2xl font-semibold text-gray-700 mb-5 ">{heading}</h1>
...
<div className='flex gap-5'>
            ...
            <button
             ...
             {
              currentPath == '/task' && <div className="flex justify-end items-center">
                <Link to="/addTask">
