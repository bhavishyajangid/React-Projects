      ...
      <div className="w-full  m-auto flex flex-col gap-2 mt-10 ">
        ...
        {Object.keys(orderDetails).length === 0 ? (
            ...
            orderedItem.map((item , index) => (
              <div key={index} className="w-full h-16 flex justify-between items-center text-sm font-medium border border-gray-300 mt-3 pr-3 ">
              ...
              <span className="w-36 text-center max-sm:font-normal">
