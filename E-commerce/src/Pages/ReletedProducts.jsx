...
const ReletedProducts = ({category}) => {
    ...
    const reletedProduct =  allProducts.filter((item) => item.category  == category).slice(0 , 5)
    console.log(reletedProduct , 'releted pr');
    
  return (
    <>
    {
        reletedProduct.length  !== 0 ? (<div className='w-4/5 max-lg:w-11/12 m-auto mt-14 '>
