...
<div className='w-1/2 h-12 flex justify-between overflow-hidden border border-solid border-r-0 border-gray-300 mt-4 max-md:w-4/5 max-sm:w-full max-sm:h-10'>
    ...
    <Button className='w-36 h-12 max-sm:h-10 bg-black text-white rounded-none text-[13px] font-normal max-sm:text-xs max-sm:w-32  'text='SUBSCRIBE' path='/subscription'/>
</div>
    </div>
  )
}
