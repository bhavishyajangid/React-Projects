...
const Tittle = ({text1 , text2 , para = true}) => {
  return (
    <div className='w-full px-5 py-5 text-center leading-9 max-sm:leading-6'>
        ...
        {
          para && <p className='text-[#AAAEB5]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
        }
